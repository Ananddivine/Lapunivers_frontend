...
import processor from'../Assets/processor.jpeg';
import chiplevel from '../Assets/chiplevel.jpeg';
  ...
  return (
    <section id="time-line">
      ...
      <div className="timelines">
       ...
       <div className='processor'> <img src={processor} alt='processor' /></div>     
        <div className="sections">
